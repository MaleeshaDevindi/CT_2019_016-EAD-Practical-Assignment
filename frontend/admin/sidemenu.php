...
$menu_items = [
    ...
    'courses' => [
        ...
        'label' => 'Courses',
        'submenu' => [
            ['url' => 'add-course.php', 'icon' => 'fas fa-plus', 'label' => 'Add Course'],
    ...
    'students' => [
        ...
        'label' => 'Students',
        'submenu' => [
            ['url' => 'add-student.php', 'icon' => 'fas fa-user-plus', 'label' => 'Add Student'],
            ['url' => 'all-students.php', 'icon' => 'fas fa-users', 'label' => 'All Students'],
        ],
    ],
    'instructors' => [
        ...
        'label' => 'Instructors',
        'submenu' => [
            ['url' => 'add-instructor.php', 'icon' => 'fas fa-user-plus', 'label' => 'Add Instructor'],
            ['url' => 'all-instructors.php', 'icon' => 'fas fa-users', 'label' => 'All Instructors'],
        ],
    ],
    'reports' => [
        ...
        'label' => 'Reports',
        'submenu' => [
            ['url' => 'course-reports.php', 'icon' => 'fas fa-chart-line', 'label' => 'Course Reports'],
            ['url' => 'student-reports.php', 'icon' => 'fas fa-chart-pie', 'label' => 'Student Reports'],
        ],
    ],
